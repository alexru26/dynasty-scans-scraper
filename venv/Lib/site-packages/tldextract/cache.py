...
class DiskCache:
    ...
    def get(self, namespace: str, ***REMOVED***str | dict[str, Hashable]) -> object:
        ...
        if not os.path.isfile(cache_filepath):
            raise KeyError("namespace: " + namespace + " ***REMOVED***" + repr(key))
        try:
            ...
            raise KeyError("namespace: " + namespace + " ***REMOVED***" + repr(key)) from None

    def set(
        self, namespace: str, ***REMOVED***str | dict[str, Hashable], value: object
    ) -> None:
    ...
    def _key_to_cachefile_path(
        self, namespace: str, ***REMOVED***str | dict[str, Hashable]
    ) -> str:
