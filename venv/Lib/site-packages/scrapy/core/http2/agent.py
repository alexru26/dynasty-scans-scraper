...
class H2ConnectionPool:
    ...
    def get_connection(
        self, ***REMOVED***Tuple, uri: URI, endpoint: HostnameEndpoint
    ) -> Deferred:
    ...
    def put_connection(self, conn: H2ClientProtocol, ***REMOVED***Tuple) -> H2ClientProtocol:
    ...
    def _remove_connection(self, errors: List[BaseException], ***REMOVED***Tuple) -> None:
