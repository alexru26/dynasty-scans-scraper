...
class StatsCollector:
    ...
    def get_value(
        self, ***REMOVED***str, default: Any = None, spider: Optional[Spider] = None
    ) -> Any:
    ...
    def set_value(self, ***REMOVED***str, value: Any, spider: Optional[Spider] = None) -> None:
    ...
    def inc_value(
        self, ***REMOVED***str, count: int = 1, start: int = 0, spider: Optional[Spider] = None
    ) -> None:
        d = self._stats
        d[key] = d.setdefault(key, start) + count

    def max_value(self, ***REMOVED***str, value: Any, spider: Optional[Spider] = None) -> None:
        self._stats[key] = max(self._stats.setdefault(key, value), value)

    def min_value(self, ***REMOVED***str, value: Any, spider: Optional[Spider] = None) -> None:
