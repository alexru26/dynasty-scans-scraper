...
class Request:
    ...
    # writing to.
    def getHeader(self, ***REMOVED***AnyStr) -> Optional[AnyStr]:
        """
        Get an HTTP request header.

        @type ***REMOVED***C{bytes} or C{str}
        @param ***REMOVED***The name of the header to get the value of.
    ...
    def getCookie(self, key):
        ...
        @type ***REMOVED***C{bytes}
        @param ***REMOVED***The name of the cookie to get.
