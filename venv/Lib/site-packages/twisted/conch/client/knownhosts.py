...
class KnownHostsFile:
    ...
    def hasHostKey(self, hostname, key):
        ...
        @param ***REMOVED***The public key to check for.
        @type ***REMOVED***L{Key}
    ...
    def verifyHostKey(self, ui, hostname, ip, key):
        ...
        @param ***REMOVED***The public key of the server.
    ...
    def addHostKey(self, hostname, key):
        ...
        @param ***REMOVED***The public key to associate with the new entry.
        @type ***REMOVED***L{Key}
