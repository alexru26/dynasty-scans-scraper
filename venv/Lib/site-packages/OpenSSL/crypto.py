...
class PKey:
    ...
    @classmethod
    def from_cryptography_key(cls, crypto_***REMOVED***_Key) -> "PKey":
        """
        Construct based on a ``cryptography`` *crypto_key*.

        :param crypto_***REMOVED***A ``cryptography`` key.
        :type crypto_***REMOVED***One of ``cryptography``'s `key interfaces`_.
...
class X509Req:
    ...
    def set_pubkey(self, p***REMOVED***PKey) -> None:
        """
        Set the public key of the certificate signing request.

        :param p***REMOVED***The public key to use.
        :type p***REMOVED***:py:class:`PKey`
    ...
    def sign(self, p***REMOVED***PKey, digest: str) -> None:
        """
        Sign the certificate signing request with this key and digest type.

        :param p***REMOVED***The key pair to sign with.
        :type p***REMOVED***:py:class:`PKey`
    ...
    def verify(self, p***REMOVED***PKey) -> bool:
        """
        Verifies the signature on this certificate signing request.

        :param PKey ***REMOVED***A public key.
...
class X509:
    ...
    def from_cryptography(cls, crypto_cert: x509.Certificate) -> "X509":
        ...
        :param crypto_***REMOVED***A ``cryptography`` X.509 certificate.
        :type crypto_***REMOVED***``cryptography.x509.Certificate``
    ...
    def set_pubkey(self, p***REMOVED***PKey) -> None:
        ...
        :param p***REMOVED***The public key.
        :type p***REMOVED***:py:class:`PKey`
    ...
    def sign(self, p***REMOVED***PKey, digest: str) -> None:
        ...
        :param p***REMOVED***The key to sign with.
        :type p***REMOVED***:py:class:`PKey`
...
def dump_publickey(type: int, p***REMOVED***PKey) -> bytes:
    """
    Dump a public key to a buffer.

    :param type: The file type (one of :data:`FILETYPE_PEM` or
        :data:`FILETYPE_ASN1`).
    :param PKey p***REMOVED***The public key to dump
...
def dump_privatekey(
    ...
    *type*.  Optionally (if *type* is :const:`FILETYPE_PEM`) encrypting it
    ...
    :param PKey p***REMOVED***The PKey to dump
...
class CRL:
    ...
    def sign(self, issuer_cert: X509, issuer_***REMOVED***PKey, digest: bytes) -> None:
        """
        Sign the CRL.
        ...
        :param PKey issuer_***REMOVED***The issuer's private key.
    ...
    def export(
        ...
        ***REMOVED***PKey,
        ...
        :param PKey ***REMOVED***The key used to sign the CRL.
...
class PKCS12:
    ...
    def __init__(self) -> None:
        self._p***REMOVED***Optional[PKey] = None
    ...
    def set_privatekey(self, p***REMOVED***PKey) -> None:
        """
        Set the certificate portion of the PKCS #12 structure.

        :param p***REMOVED***The new private key, or :py:const:`None` to unset it.
        :type p***REMOVED***:py:class:`PKey` or :py:const:`None`
...
class NetscapeSPKI:
    ...
    def sign(self, p***REMOVED***PKey, digest: str) -> None:
        ...
        :param p***REMOVED***The private key to sign with.
        :type p***REMOVED***:py:class:`PKey`
    ...
    def verify(self, ***REMOVED***PKey) -> bool:
        """
        Verifies a signature on a certificate request.

        :param PKey ***REMOVED***The public key that signature is supposedly from.
...
def sign(p***REMOVED***PKey, data: Union[str, bytes], digest: str) -> bytes:
    """
    Sign a data string using the given key and message digest.

    :param p***REMOVED***PKey to sign with
