...
def _get_ssh_key_type(
    ***REMOVED***typing.Union[SSHPrivateKeyTypes, SSHPublicKeyTypes]
) -> bytes:
...
def _ecdsa_key_type(public_***REMOVED***ec.EllipticCurvePublicKey) -> bytes:
    """Return SSH key_type and curve_name for private key."""
    curve = public_key.curve
    if curve.name not in _ECDSA_KEY_TYPE:
        raise ValueError(
            f"Unsupported curve for ssh private ***REMOVED***{curve.name!r}"
        )
...
class _SSHFormatRSA:
    ...
    def encode_public(
        self, public_***REMOVED***rsa.RSAPublicKey, f_pub: _FragList
    ) -> None:
    ...
    def encode_private(
        self, private_***REMOVED***rsa.RSAPrivateKey, f_priv: _FragList
    ) -> None:
...
class _SSHFormatDSA:
    ...
    def encode_public(
        self, public_***REMOVED***dsa.DSAPublicKey, f_pub: _FragList
    ) -> None:
    ...
    def encode_private(
        self, private_***REMOVED***dsa.DSAPrivateKey, f_priv: _FragList
    ) -> None:
...
class _SSHFormatECDSA:
    ...
    def encode_public(
        self, public_***REMOVED***ec.EllipticCurvePublicKey, f_pub: _FragList
    ) -> None:
    ...
    def encode_private(
        self, private_***REMOVED***ec.EllipticCurvePrivateKey, f_priv: _FragList
    ) -> None:
...
class _SSHFormatEd25519:
    ...
    def encode_public(
        self, public_***REMOVED***ed25519.Ed25519PublicKey, f_pub: _FragList
    ) -> None:
    ...
    def encode_private(
        self, private_***REMOVED***ed25519.Ed25519PrivateKey, f_priv: _FragList
    ) -> None:
...
def _serialize_ssh_private_key(
    private_***REMOVED***SSHPrivateKeyTypes,
    password: bytes,
...
class SSHCertificate:
    def __init__(
        self,
        _nonce: memoryview,
        _public_***REMOVED***SSHPublicKeyTypes,
        _serial: int,
        _cctype: int,
        _key_id: memoryview,
...
def load_ssh_public_key(
    ...
    public_***REMOVED***SSHPublicKeyTypes
...
def serialize_ssh_public_key(public_***REMOVED***SSHPublicKeyTypes) -> bytes:
...
class SSHCertificateBuilder:
    def __init__(
        self,
        _public_***REMOVED***typing.Optional[SSHCertPublicKeyTypes] = None,
    ...
    def public_key(
        self, public_***REMOVED***SSHCertPublicKeyTypes
    ...
    def sign(self, private_***REMOVED***SSHCertPrivateKeyTypes) -> SSHCertificate:
        if not isinstance(
            private_key,
            (
                ec.EllipticCurvePrivateKey,
