...
def _get_rsa_pss_salt_length(
    backend: Backend,
    pss: PSS,
    ***REMOVED***typing.Union[RSAPrivateKey, RSAPublicKey],
...
def _enc_dec_rsa(
    backend: Backend,
    ***REMOVED***typing.Union[_RSAPrivateKey, _RSAPublicKey],
    data: bytes,
...
def _rsa_sig_setup(
    ...
    padding: AsymmetricPadding,
    algorithm: typing.Optional[hashes.HashAlgorithm],
    ***REMOVED***typing.Union[_RSAPublicKey, _RSAPrivateKey],
...
def _rsa_sig_sign(
    ...
    private_***REMOVED***_RSAPrivateKey,
    data: bytes,
) -> bytes:
